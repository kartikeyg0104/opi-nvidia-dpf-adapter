...
func main() {
	...
	flag.StringVar(&mappingDir, "mapping-dir", "config/mappings",
		"Directory of FieldMapping YAML documents that drive OPI→DPF translation.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9ab915d2.opi.nvidia.com",
	...
	specs, err := mapping.LoadDir(mappingDir)
	if err != nil {
		setupLog.Error(err, "Failed to load FieldMapping documents", "mapping-dir", mappingDir)
		os.Exit(1)
	}
	for _, spec := range specs {
		registerUnstructured(scheme, spec.Source.GVK())
		...
		if err := rec.SetupWithManager(mgr); err != nil {
			setupLog.Error(err, "Failed to create controller", "mapping", spec.Metadata.Name, "kind", spec.Source.Kind)
			os.Exit(1)
		}
